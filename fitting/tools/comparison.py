...
draw(f'{OUT}/cco/3d/cylinder/synthetic/cylinder_4k/run_1/2026-0623/20*/record.json', 3, 'CCO')
...
fig.savefig('/home/m25lll/code/Fiting/outputs/cylinder_clean_all_three.pdf')
plt.show()
