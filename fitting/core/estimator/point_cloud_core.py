...
class PointCloudEstimatorCore:
    def __init__(self, cfg, owner=None, estimator_type=None):
        self.cfg = cfg
        self.dimension = None
        self.raw_data = None
        self.data = None
        ...
        if estimator_type is None:
            estimator_type = estimator_cfg.get("estimator_type", estimator_cfg.get("type", "npre"))
    ...
    def estimate(self):
        ...
        if self.estimator_type in {"npre", "gd"}:
